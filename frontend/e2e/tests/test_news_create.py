...
class TestNewsCreate:
    ...
    def test_create_news_requires_auth(self, page):
        ...
        create_page.check_no_redirect_to_create()
        assert "/login" in page.url

    @allure.story("Создание новости с валидными данными")
    @allure.severity(allure.severity_level.CRITICAL)
    def test_create_news_success(self, page, login):
        create_page = NewsCreatePage(page)
        create_page.navigate("/news/create")
        create_page.check_redirect_to_create()
        ...
        create_page.check_redirect_to_news()
    ...
    def test_create_news_no_title(self, page, login):
        create_page = NewsCreatePage(page)
        create_page.navigate("/news/create")
        create_page.check_redirect_to_create()
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_create_news_no_text(self, page, login):
        create_page = NewsCreatePage(page)
        create_page.navigate("/news/create")
        create_page.check_redirect_to_create()
